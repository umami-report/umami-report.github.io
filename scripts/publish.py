...
html=("<!DOCTYPE html><html lang='ja'><head><meta charset='UTF-8'><meta name='viewport' content='width=device-width,initial-scale=1.0'>"
    ...
    "</section>"
    f"<section class='news-section' id='patents'><div class='section-header'><div class='bar' style='background:#7c3aed'></div><h2 class='section-label'>PATENT - チョコ・油性菓子 特許</h2><span class='section-count'>{total_pat} PATENTS (30日以内)</span></div>"
